...
urlpatterns = [
    ...
    path('business/happyhour/', views.business_happyhour, name='business_top'), #Use Case 3
    ...
    path('business/top/<zip>/', views.business_find_topten, name='business_find_topten'), #Use Case 1
    path('business/<category>/', views.business_category, name='business_category'), #Use Case 4
    ...
    path('business/takeout/', views.business_takeout, name='business_takeout'), #Use Case 10
    path('business/avg_rating/<city>/', views.business_avgrating_city, name='business_avgrating_city'), #Use Case 11
    path('business/avg_rating/<state>/', views.business_avgrating_state, name='business_avgrating_state'), #Use Case 12
    ...
    path('business/openon/', views.business_openday, name='business_openday') #Use Case 15
]
